...
@section('content')
    ...
    <div id="page-wrapper">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                             ...
                             <li>
                                <i class="fa fa-file-text"></i>  <a href="{{ url('/suratmasuk') }}">Dokumen</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-plus-square"></i> Tambah Dokumen
                            </li>
                        </ol>
                    </div>
                </div>
           ...
           <div>
            ...
            <div class="col-xs-5" >
                {{ Form::open(['url' => '/prosestambahdokumen','files'=>'true']) }}
                ...
                <div class="input-group date col-xs-8"> 
                    ...
                    {!! Form::text('tanggal_upload', '', ['placeholder'=>'Tanggal', 'id' => 'datepicker','class' => 'form-control']) !!}
                   
                </div>
                <p></p>
                <label>Keterangan</label>
                {{ Form::textarea('keterangan', '', ['placeholder'=>'Keterangan','class' => 'form-control', 'size' => '30x5']) }}
                <p></p>
